...
func autoConvert_v1alpha2_ChallengeSpec_To_acme_ChallengeSpec(in *v1alpha2.ChallengeSpec, out *acme.ChallengeSpec, s conversion.Scope) error {
	...
	if in.Solver != nil {
		...
		*out = new(acme.ACMEChallengeSolver)
		if err := Convert_v1alpha2_ACMEChallengeSolver_To_acme_ACMEChallengeSolver(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Solver = nil
...
func autoConvert_acme_ChallengeSpec_To_v1alpha2_ChallengeSpec(in *acme.ChallengeSpec, out *v1alpha2.ChallengeSpec, s conversion.Scope) error {
	...
	if in.Solver != nil {
		in, out := &in.Solver, &out.Solver
		*out = new(v1alpha2.ACMEChallengeSolver)
		if err := Convert_acme_ACMEChallengeSolver_To_v1alpha2_ACMEChallengeSolver(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Solver = nil
