...
func (in *ACMEChallengeSolverDNS01) DeepCopyInto(out *ACMEChallengeSolverDNS01) {
	*out = *in
	...
	if in.OCIDNS != nil {
		in, out := &in.OCIDNS, &out.OCIDNS
		*out = new(ACMEIssuerDNS01ProviderOCIDNS)
		(*in).DeepCopyInto(*out)
	}
	if in.DynDNS != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ACMEIssuerDNS01ProviderOCIDNS) DeepCopyInto(out *ACMEIssuerDNS01ProviderOCIDNS) {
	*out = *in
	if in.ServiceAccount != nil {
		in, out := &in.ServiceAccount, &out.ServiceAccount
		*out = new(meta.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ACMEIssuerDNS01ProviderOCIDNS.
func (in *ACMEIssuerDNS01ProviderOCIDNS) DeepCopy() *ACMEIssuerDNS01ProviderOCIDNS {
	if in == nil {
		return nil
	}
	out := new(ACMEIssuerDNS01ProviderOCIDNS)
